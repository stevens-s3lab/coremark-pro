...
PACK_OPTS = $(ASAN_FLAGS) --sysroot $(HOME)/Projects/s3lab/asan-stm/db-root
...
LINKER_FLAGS	+= $(ASAN_FLAGS) --sysroot $(HOME)/Projects/s3lab/asan-stm/db-root -fuse-ld=$(TOOLS)/bin/ld.lld
