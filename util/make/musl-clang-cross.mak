...
TOOLS	= $(HOME)/software/llvm
WRAPPERD= $(HOME)/software/aarch64/usr/local/musl/bin
...
PACK_OPTS = -ffixed-x18 -v $(ASAN_FLAGS) $(DECOUPLE_FLAGS)
...
LINKER_FLAGS	+= -lm -lpthread --rtlib=compiler-rt $(ASAN_FLAGS)
